class MS4 extends Phaser.Scene 
{
    ...
    */
    ...
    {
        // First enemy
        this.enemyImg = this.physics.add.sprite(615, 100, 'bag of bones');
        ...
        // second enemy
        this.enemyImg2 = this.physics.add.sprite(350, 100, 'bag of bones');
        this.enemyImg2.setScale(0.75);
        this.enemyImg2.setOrigin(0.5);
        this.enemyImg2.body.setGravityY(300);
        this.enemyImg2.setSize(45, 50);
        this.enemyImg2.flipX = true

        this.enemies.push(this.enemyImg2);
        ...
        this.enemyImg2.setCollideWorldBounds(true);
